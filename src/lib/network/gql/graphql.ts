...
export type EnvironmentItemFragment = {
  __typename?: "Environment";
  id: string;
  name: string;
  serviceInstances: {
    ...
    edges: Array<{
      ...
      node: {
        ...
        latestDeployment?:
          | ({ __typename?: "Deployment" } & {
              " $fragmentRefs"?: {
                DeploymentItemFragment: DeploymentItemFragment;
              };
            })
          | null;
      } & {
        " $fragmentRefs"?: {
          ServiceInstanceItemFragment: ServiceInstanceItemFragment;
        };
      };
    }>;
  };
...
export type DeploymentItemFragment = {
  __typename?: "Deployment";
  id: string;
  status: DeploymentStatus;
  createdAt: any;
...
} & { " $fragmentName"?: "DeploymentItemFragment" };

export type ServiceInstanceItemFragment = {
  __typename?: "ServiceInstance";
  id: string;
  ...
  latestDeployment?:
    ...
    | null;
} & { " $fragmentName"?: "ServiceInstanceItemFragment" };
    ...
    edges: Array<{
      ...
      node: {
        ...
        serviceInstances: {
          ...
          edges: Array<{
            __typename?: "EnvironmentServiceInstancesConnectionEdge";
            node: { __typename?: "ServiceInstance"; serviceId: string };
          }>;
        };
      } & {
    ...
    edges: Array<{
      ...
      node: {
        ...
        environments: {
          ...
          edges: Array<{
            __typename?: "ProjectEnvironmentsConnectionEdge";
            node: { __typename?: "Environment"; id: string };
          }>;
        };
...
export type ServiceInstanceRedeployMutation = {
  __typename?: "Mutation";
...
export type DeploymentStopMutation = {
  __typename?: "Mutation";
...
export type GetEnvironmentMetricsQuery = {
  __typename?: "Query";
  metrics: Array<{
    __typename?: "MetricsResult";
    measurement: MetricMeasurement;
    values: Array<{ __typename?: "Metric"; ts: number; value: number }>;
    tags: { __typename?: "MetricTags"; serviceId?: string | null };
  }>;
};

export const DeploymentItemFragmentDoc = {
  kind: "Document",
  definitions: [
    {
      kind: "FragmentDefinition",
      name: { kind: "Name", value: "DeploymentItem" },
      typeCondition: {
        kind: "NamedType",
      ...
      selectionSet: {
        ...
        selections: [
          ...
          { kind: "Field", name: { kind: "Name", value: "staticUrl" } },
          {
            kind: "Field",
            name: { kind: "Name", value: "suggestAddServiceDomain" },
          },
        ],
      },
    },
  ],
} as unknown as DocumentNode<DeploymentItemFragment, unknown>;
export const ServiceInstanceItemFragmentDoc = {
  kind: "Document",
  definitions: [
    {
      kind: "FragmentDefinition",
      name: { kind: "Name", value: "ServiceInstanceItem" },
      typeCondition: {
        kind: "NamedType",
        name: { kind: "Name", value: "ServiceInstance" },
      },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          ...
          { kind: "Field", name: { kind: "Name", value: "healthcheckPath" } },
          { kind: "Field", name: { kind: "Name", value: "numReplicas" } },
...
} as unknown as DocumentNode<ServiceInstanceItemFragment, unknown>;
export const EnvironmentItemFragmentDoc = {
  kind: "Document",
  definitions: [
    {
      kind: "FragmentDefinition",
      name: { kind: "Name", value: "EnvironmentItem" },
      typeCondition: {
        kind: "NamedType",
      ...
      selectionSet: {
        ...
        selections: [
          ...
          {
            kind: "Field",
            name: { kind: "Name", value: "serviceInstances" },
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                {
...
} as unknown as DocumentNode<EnvironmentItemFragment, unknown>;
  ...
  definitions: [
    {
      ...
      operation: "mutation",
      name: { kind: "Name", value: "serviceInstanceUpdate" },
      variableDefinitions: [
        {
        ...
        },
        {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "ServiceInstanceUpdateInput" },
            },
          },
        },
      ],
...
export const ServiceInstanceRedeployDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "serviceInstanceRedeploy" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "deploymentLogs" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
...
} as unknown as DocumentNode<DeploymentLogsQuery, DeploymentLogsQueryVariables>;
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "deploymentStop" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "id" } },
...
>;
export const GetEnvironmentMetricsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "getEnvironmentMetrics" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
          ...
          type: {
            ...
            type: {
              ...
              type: {
                ...
                type: {
                  kind: "NamedType",
                  name: { kind: "Name", value: "MetricMeasurement" },
                },
              },
            },
          },
        ...
        selections: [
          {
            ...
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                { kind: "Field", name: { kind: "Name", value: "measurement" } },
                {
                  kind: "Field",
