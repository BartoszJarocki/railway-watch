...
export type ServiceItemFragment = { __typename?: 'Service', id: string, name: string, projectId: string, serviceInstances: { __typename?: 'ServiceServiceInstancesConnection', edges: Array<{ __typename?: 'ServiceServiceInstancesConnectionEdge', node: (
