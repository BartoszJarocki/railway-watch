...
export const useServiceQuery = <
    ...
    return useQuery<ServiceQuery, TError, TData>(
      ['service', variables],
      fetcher<ServiceQuery, ServiceQueryVariables>(dataSource.endpoint, dataSource.fetchParams || {}, ServiceDocument, variables),
      options
    )};

export const DeploymentTriggerCreateDocument = `
...
export const useDeploymentTriggerCreateMutation = <
      TError = unknown,
      TContext = unknown
    >(
      dataSource: { endpoint: string, fetchParams?: RequestInit },
      options?: UseMutationOptions<DeploymentTriggerCreateMutation, TError, DeploymentTriggerCreateMutationVariables, TContext>
    ) => {
    
    return useMutation<DeploymentTriggerCreateMutation, TError, DeploymentTriggerCreateMutationVariables, TContext>(
      ['deploymentTriggerCreate'],
      (variables?: DeploymentTriggerCreateMutationVariables) => fetcher<DeploymentTriggerCreateMutation, DeploymentTriggerCreateMutationVariables>(dataSource.endpoint, dataSource.fetchParams || {}, DeploymentTriggerCreateDocument, variables)(),
      options
    )};
...
export const useServiceInstanceDeployMutation = <
      TError = unknown,
      TContext = unknown
    >(
      dataSource: { endpoint: string, fetchParams?: RequestInit },
      options?: UseMutationOptions<ServiceInstanceDeployMutation, TError, ServiceInstanceDeployMutationVariables, TContext>
    ) => {
    
    return useMutation<ServiceInstanceDeployMutation, TError, ServiceInstanceDeployMutationVariables, TContext>(
      ['serviceInstanceDeploy'],
      (variables?: ServiceInstanceDeployMutationVariables) => fetcher<ServiceInstanceDeployMutation, ServiceInstanceDeployMutationVariables>(dataSource.endpoint, dataSource.fetchParams || {}, ServiceInstanceDeployDocument, variables)(),
      options
    )};

export const DeploymentLogsDocument = `
...
export const useDeploymentLogsQuery = <
      TData = DeploymentLogsQuery,
      TError = unknown
    >(
      dataSource: { endpoint: string, fetchParams?: RequestInit },
      variables: DeploymentLogsQueryVariables,
      options?: UseQueryOptions<DeploymentLogsQuery, TError, TData>
    ) => {
    
    return useQuery<DeploymentLogsQuery, TError, TData>(
      ['deploymentLogs', variables],
      fetcher<DeploymentLogsQuery, DeploymentLogsQueryVariables>(dataSource.endpoint, dataSource.fetchParams || {}, DeploymentLogsDocument, variables),
      options
    )};
...
export const useDeploymentStopMutation = <
      TError = unknown,
      TContext = unknown
    >(
      dataSource: { endpoint: string, fetchParams?: RequestInit },
      options?: UseMutationOptions<DeploymentStopMutation, TError, DeploymentStopMutationVariables, TContext>
    ) => {
    
    return useMutation<DeploymentStopMutation, TError, DeploymentStopMutationVariables, TContext>(
      ['deploymentStop'],
      (variables?: DeploymentStopMutationVariables) => fetcher<DeploymentStopMutation, DeploymentStopMutationVariables>(dataSource.endpoint, dataSource.fetchParams || {}, DeploymentStopDocument, variables)(),
      options
    )};

export const DeploymentRestartDocument = `
    mutation deploymentRestart($id: String!) {
  deploymentRestart(id: $id)
}
    `;

export const useDeploymentRestartMutation = <
      TError = unknown,
      TContext = unknown
    >(
      dataSource: { endpoint: string, fetchParams?: RequestInit },
      options?: UseMutationOptions<DeploymentRestartMutation, TError, DeploymentRestartMutationVariables, TContext>
    ) => {
    
    return useMutation<DeploymentRestartMutation, TError, DeploymentRestartMutationVariables, TContext>(
      ['deploymentRestart'],
      (variables?: DeploymentRestartMutationVariables) => fetcher<DeploymentRestartMutation, DeploymentRestartMutationVariables>(dataSource.endpoint, dataSource.fetchParams || {}, DeploymentRestartDocument, variables)(),
      options
    )};
