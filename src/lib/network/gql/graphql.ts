...
export type ServiceItemFragment = { __typename?: 'Service', id: string, name: string, icon?: string | null, deletedAt?: any | null, projectId: string, serviceInstances: { __typename?: 'ServiceServiceInstancesConnection', edges: Array<{ __typename?: 'ServiceServiceInstancesConnectionEdge', node: (
        { __typename?: 'ServiceInstance', id: string, latestDeployment?: (
          { __typename?: 'Deployment' }
          & { ' $fragmentRefs'?: { 'DeploymentItemFragment': DeploymentItemFragment } }
        ) | null }
