...
export type ServiceInstanceItemFragment = { __typename?: 'ServiceInstance', id: string, healthcheckPath?: string | null, numReplicas?: number | null, region?: string | null, serviceId: string, serviceName: string, latestDeployment?: (
    { __typename?: 'Deployment', createdAt: any, url?: string | null, status: DeploymentStatus }
...
export type ProjectItemFragment = { __typename?: 'Project', id: string, name: string, description?: string | null, createdAt: any, isPublic: boolean, services: { __typename?: 'ProjectServicesConnection', edges: Array<{ __typename?: 'ProjectServicesConnectionEdge', node: (
