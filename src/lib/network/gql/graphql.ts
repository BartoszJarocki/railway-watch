...
export type ServiceInstanceItemFragment = { __typename?: 'ServiceInstance', id: string, environmentId: string, healthcheckPath?: string | null, numReplicas?: number | null, region?: string | null, serviceId: string, serviceName: string, latestDeployment?: (
    { __typename?: 'Deployment', id: string, createdAt: any, url?: string | null, status: DeploymentStatus, serviceId?: string | null }
    & { ' $fragmentRefs'?: { 'DeploymentItemFragment': DeploymentItemFragment } }
